...
```
Adding optional fields is non-breaking. Making a field required later forces updating all existing content.
...
```
Use when content shares a collection but has fundamentally different shapes.
