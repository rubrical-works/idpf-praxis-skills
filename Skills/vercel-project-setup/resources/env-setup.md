...
**Where to get it:** Vercel Dashboard > Settings > Tokens

1. Go to https://vercel.com/account/tokens
2. Click "Create" to generate a new token
3. Name it (e.g., "GitHub Actions")
4. Set scope to your team or personal account
...
- Use Vercel CLI `vercel env pull .env.local` to sync variables locally
