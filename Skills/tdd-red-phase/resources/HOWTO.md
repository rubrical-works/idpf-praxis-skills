...
- Update `test-structure-patterns.md` to include only the test frameworks your project uses (e.g., keep Jest, remove pytest/Go/Rust)
- Adjust naming conventions in the checklist to match your team's test naming standards
