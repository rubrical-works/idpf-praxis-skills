...
Guide experienced developers through the GREEN phase of TDD -- writing minimal implementation to make failing tests pass.
...
In IDPF projects, the tdd-green-phase skill is a default skill loaded automatically during the GREEN phase of TDD story implementation, immediately after a RED phase test is verified as failing. The approach above replicates that behavior for any Claude Code project.
