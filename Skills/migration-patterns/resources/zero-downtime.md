...
### Timeline
```
Day 1: Deploy Expand Migration + Application (reads both old and new)
Day 2: Run Data Migration
Day 3: Deploy Application (reads only new) + Contract Migration
```
...
```
**Limitations:** Cannot run in transaction, takes longer, may fail and leave invalid index.
